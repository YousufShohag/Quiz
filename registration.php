...
<header class="absolute inset-x-0 top-0 z-50">
  ...
  <div class="bg-white shadow-md rounded px-12 pt-6 pb-8 mb-4">
    ...
    <form>
       <div class="mb-4">
        ...
        <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="fullname" type="text" placeholder="Full Name">
      </div>
      <div class="mb-4">
        <label class="block text-gray-700 text-sm font-bold mb-2" for="username">
          Username
      ...
      <div class="mb-6">
       ...
       <select class="appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" name="position" id="position">
    ...
    <div class="bottom" style="margin-top:20px;">
            <p>Already have an account?Please  <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="login.php">Sign in Here</a> </p>
    </div>
  </div>
