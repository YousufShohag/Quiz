...
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <header class="absolute inset-x-0 top-0 z-50">
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                    <a href="registration.php" class="text-sm font-semibold leading-6 text-gray-900">Sign Up <span
  ...
  <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    ...
    <div class="bottom" style="margin-top:20px;">
            <p>If you have  new Please <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800" href="registration.php">Sign Up Here</a> </p>
    </div>
  </div>
